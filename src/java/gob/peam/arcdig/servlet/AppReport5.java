 ...
 * @author alabajos
 */
@WebServlet(name = "AppReport5", urlPatterns = {"/AppReport5.pdf"})
public class AppReport5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(AppReport5.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
    ...
    public JasperPrint crearReporte(String formato) throws JRException, SQLException, ServletException, ClassNotFoundException, ParserConfigurationException, SAXException, IOException {
        ...
        if ("pdf".equals(formato)) {
            masterReport = (JasperReport) JRLoader.loadObject(rutafisica + "/registro_detallado.jasper");
        } else {
            masterReport = (JasperReport) JRLoader.loadObject(rutafisica + "/registro_detallado_xls.jasper");
        }
