 ...
 * @author alabajos
 */
@WebServlet(name = "AppReport2", urlPatterns = {"/AppReport2.pdf"})
public class AppReport2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(AppReport2.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
    ...
    public JasperPrint crearReporte(String formato) throws JRException, SQLException, ServletException, ClassNotFoundException, ParserConfigurationException, SAXException, IOException {
        ...
        if ("pdf".equals(formato)) {
            masterReport = (JasperReport) JRLoader.loadObject(rutafisica + "/registro_x_catalogo.jasper");
        } else {
            masterReport = (JasperReport) JRLoader.loadObject(rutafisica + "/registro_x_catalogo_xls.jasper");
        }
