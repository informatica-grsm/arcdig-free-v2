 ...
 * @author Usuario
 */
@WebServlet(name = "DownloadSoloServlet", urlPatterns = {"/downloadsolo.pdf"})
public class DownloadSoloServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Documento item : new DocumentoDao().getRelacionSubGrupo(d.getSubGrupo(), d.getDocuGroup())) {
