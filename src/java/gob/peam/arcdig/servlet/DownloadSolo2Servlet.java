 ...
 * @author Usuario
 */
@WebServlet(name = "DownloadSolo2Servlet", urlPatterns = {"/downloadsolo2.pdf"})
public class DownloadSolo2Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Documento d = new DocumentoDao().getDocumento(id); 
        
        for (Documento item : new DocumentoDao().getRelacionSubGrupo2(d.getSubGrupo2(), d.getDocuGroup())) {
