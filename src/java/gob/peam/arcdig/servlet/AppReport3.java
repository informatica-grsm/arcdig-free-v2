 ...
 * @author alabajos
 */
@WebServlet(name = "AppReport3", urlPatterns = {"/AppReport3.pdf"})
public class AppReport3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(AppReport3.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
    ...
    public JasperPrint crearReporte(String formato) throws JRException, SQLException, ServletException, ClassNotFoundException, ParserConfigurationException, SAXException, IOException {
        ...
        if ("pdf".equals(formato)) {
            masterReport = (JasperReport) JRLoader.loadObject(rutafisica + "/registro_x_detalle.jasper");
        } else {
            masterReport = (JasperReport) JRLoader.loadObject(rutafisica + "/registro_x_detalle_xls.jasper");
        }
