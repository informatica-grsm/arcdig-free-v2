 ...
 * @author alabajos
 */
@WebServlet(name = "AppReport1", urlPatterns = {"/AppReport1.pdf"})
public class AppReport1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(AppReport1.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
    }
    ...
    public JasperPrint crearReporte(String formato) throws JRException, SQLException, ServletException, ClassNotFoundException, ParserConfigurationException, SAXException, IOException {
        ...
        if ("pdf".equals(formato)) {
            masterReport = (JasperReport) JRLoader.loadObject(rutafisica + "/registro_x_personal.jasper");
        } else {
            masterReport = (JasperReport) JRLoader.loadObject(rutafisica + "/registro_x_personal_xls.jasper");
        }
