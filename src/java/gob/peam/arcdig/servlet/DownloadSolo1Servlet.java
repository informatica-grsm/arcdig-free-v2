 ...
 * @author Usuario
 */
@WebServlet(name = "DownloadSolo1Servlet", urlPatterns = {"/downloadsolo1.pdf"})
public class DownloadSolo1Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Documento item : new DocumentoDao().getRelacionSubGrupo1(d.getSubGrupo1(), d.getDocuGroup())) {
